 ...
 local function todoc(msg, success, result)
  ...
  if success then
    ...
    print('File moved to:', file)
        io.popen('composite -dissolve 30% -gravity south L.png photo/'..msg.from.id..'.png photo/'..msg.from.id..'.png')
  ...
  if success then
    ...
    os.rename(result, file)
    print('File moved to:', file)
        io.popen('composite -dissolve 30% -gravity south L.png photo/'..msg.from.id..'.jpg photo/'..msg.from.id..'.jpg')
  ...
  if success then
    ...
    os.rename(result, file)
    print('File moved to:', file)
        io.popen('composite -dissolve 30% -gravity south L.png sticker/'..msg.from.id..'.webp sticker/'..msg.from.id..'.webp')
    send_document(get_receiver(msg), file, ok_cb, false)
