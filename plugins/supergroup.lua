...
local channel_id = "ایدی گروه : "..result.peer_id.."\n"
...
local expiretime = redis:hget('expiretime', get_receiver(msg))
 ...
 -- local text = "تنظیمات گروه :\n🔸قفل لینک : "..settings.lock_link.."\n🔹قفل فلود : "..settings.flood.."\n🔸مقدار حساسیت فلود : "..NUM_MSG_MAX.."\n🔹قفل اسپم : "..settings.lock_spam.."\n🔸قفل زبان فارسی : "..settings.lock_arabic.."\n🔹قفل ورود کابران به گروه : "..settings.lock_member.."\n🔸قفل متن ورود و خروج : "..settings.lock_tgservice.."\n🔹قفل استیکر : "..settings.lock_sticker.."\🔸عمومی : "..settings.public.."\n🔹اجرای سختگیرانه تنظیمات : "..settings.strict.."\n🔸تاریخ انقضا : "..expire.." روز"
--  return text
--end
	
	local enlock = redis:get('enlock:'..msg.to.id)
   local en = ''
	if not enlock then
		en = en..'no'
		else
	...
	local fwdlock = redis:get('fwdlock:'..msg.to.id)
   local fwd = ''
	if not fwdlock then
		fwd = fwd..'no'
		else
...
local edit = redis:set('editelock'..msg.to.id,true)
	local edite = ''
	if not edit then
		edite = edite..'no'
		else 
...
local text = ""
  text = text.."⚙تنظیمات گروه "..msg.to.print_name.. ":\n✽✽✽✽✽✽"
  text=text.."\n⚙تنظیمات امنیتے🔐 :\n"
  text = text.."\n📥 #قـفل_لینـک : "..settings.lock_link
  text = text.."\n🚫 #قفـل_فلـود : "..settings.flood
  text = text.."\n🔰 #قـفل_اسپـم : "..settings.lock_spam
  text = text.."\n🔢 #تعداد_حساسیت_فلود : "..NUM_MSG_MAX.."\n✽✽✽✽✽✽"
  text = text.."\n\n⚙تنظیمات زبـان🗣 : \n"
  text = text.."\n#قفـل_زبـان_فارسے_عربـے : "..settings.lock_arabic
  text = text.."\n🔠 #قفـل_زبـان_انگلیـسے : "..en.."\n✽✽✽✽✽✽"
  text = text.."\n⚙تنظیمات ورودی↹ :\n"
  text = text.."\n🚷 #قفـل_ورود_کـاربران: "..settings.lock_member
  text = text.."\n🤖 #قفـل_ورود_ربـات : "..bots_protection
  text = text.."\n📬 #قفـل_پیغام_ورود_و_خروج : "..settings.lock_tgservice.."\n✽✽✽✽✽✽"
  text = text.."\n⚙سایـر تنظیمات🛠 \n"
  text = text.."\n💱 #قفـل_دسترسـے_cmd : "..cmd
  text = text.."\n💬 #قفـل_ویرایش_پیـام : "..edite
  text = text.."\n🔃 #قفـل_فـوروارد : "..fwd
  text = text.."\n🃏 #قفـل_استیکـر : "..settings.lock_sticker
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'link' then
			...
			return 'نام گروه : '..msg.to.print_name..'\nلینک گروه : '..group_link
		end
